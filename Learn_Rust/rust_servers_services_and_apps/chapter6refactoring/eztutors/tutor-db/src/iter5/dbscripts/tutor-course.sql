...
grant all privileges on table ezy_tutor_c6 to kai;
grant all privileges on table ezy_course_c6 to kai;
/* Load seed data for testing */
insert into ezy_tutor_c6(tutor_id, tutor_name, tutor_pic_url,tutor_profile)
values(1,'Merlene','http://s3.amazon.aws.com/pic1','Merlene is an experienced
