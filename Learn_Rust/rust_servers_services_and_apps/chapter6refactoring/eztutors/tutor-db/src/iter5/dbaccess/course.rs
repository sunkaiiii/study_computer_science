...
pub async fn get_courses_for_tutor_db(
    ...
    let course_rows = sqlx::query!(
        "SELECT tutor_id, course_id, course_name, posted_time FROM ezy_course_c5 where
        tutor_id = $1",
        tutor_id
    )
    .fetch_all(pool)
...
pub async fn post_new_course_db(
    ...
    let course_row = sqlx::query!("insert into ezy_course_c5 (course_id,tutor_id, course_name) values ($1,$2,$3) returning tutor_id, course_id,course_name, posted_time", new_course.course_id,
